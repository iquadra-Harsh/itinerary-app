import { users, itineraries, type User, type InsertUser, type Itinerary, type InsertItinerary, type UpdateItinerary } from "@shared/schema";
...
export interface IStorage {
  ...
  createItinerary(itinerary: InsertItinerary & { userId: number }): Promise<Itinerary>;
  updateItinerary(id: number, updates: Partial<UpdateItinerary>): Promise<Itinerary | undefined>;
...
export class MemStorage implements IStorage {
  ...
  async createItinerary(itinerary: InsertItinerary & { userId: number }): Promise<Itinerary> {
  ...
  async updateItinerary(id: number, updates: Partial<UpdateItinerary>): Promise<Itinerary | undefined> {
